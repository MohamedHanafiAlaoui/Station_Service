...
public interface PompeService {
    ...
    PompeDto ajouterCarburant(Long id, double quantity);
    double getAvailableStock(Long stationId, TypeCarburant type);
    List<PompeDto> getPompsByType(TypeCarburant type);
}